const listings = [
  { id:1, name:'Casio fx-991CW Scientific Calculator', category:'Study', price:90, originalPrice:1500, deposit:300, location:'Block B · 0.6 km', distance:0.6, rating:4.9, reviews:18, owner:'Aarav M.', art:'FX', image:'assets/calculator.jpg', featured:true, description:'Clean, fully working scientific calculator. Ideal for semester exams, labs, and short-term assignments.', availability:'Available today' },
  ...
  { id:3, name:'Sony WH-1000XM4 Headphones', category:'Electronics', price:600, originalPrice:10000, deposit:900, location:'Hostel C · 0.8 km', distance:0.8, rating:4.9, reviews:25, owner:'Kabir S.', art:'WH', image:'assets/headphones.jpg', featured:true, description:'Noise-cancelling headphones with case and charging cable. Perfect for a project week, travel, or presentations.', availability:'Available today' },
  { id:4, name:'Formal Black Blazer — Size M', category:'Fashion', price:150, originalPrice:2500, deposit:700, location:'Admin Block · 0.9 km', distance:0.9, rating:4.7, reviews:9, owner:'Naina P.', art:'BLAZER', image:'assets/blazer.jpg', description:'Classic black blazer suited for interviews, presentations, viva, and formal college events.', availability:'Available in 2 days' },
  { id:5, name:'Btwin Riverside Bicycle', category:'Mobility', price:720, originalPrice:12000, deposit:1200, location:'North Gate · 1.7 km', distance:1.7, rating:4.6, reviews:14, owner:'Raghav T.', art:'BIKE', image:'assets/bicycle.jpg', description:'Comfortable geared bicycle for campus commuting. Helmet available on request.', availability:'Available today' },
  { id:6, name:'Decathlon Football + Pump', category:'Sports', price:48, originalPrice:800, deposit:250, location:'Sports Complex · 0.4 km', distance:0.4, rating:4.8, reviews:21, owner:'Yash R.', art:'BALL', image:'assets/football.jpg', featured:true, description:'Match-ready football with compact hand pump. Great for weekend games or inter-department practice.', availability:'Available now' },
  { id:7, name:'Logitech MX Master 3S', category:'Electronics', price:480, originalPrice:8000, deposit:800, location:'Tech Block · 0.7 km', distance:0.7, rating:4.9, reviews:11, owner:'Meera A.', art:'MX', image:'assets/mouse.jpg', description:'Ergonomic wireless mouse with USB receiver and Bluetooth. Useful for short coding or design projects.', availability:'Available today' },
  { id:8, name:'Portable Room Heater', category:'Hostel', price:120, originalPrice:2000, deposit:500, location:'Hostel A · 0.5 km', distance:0.5, rating:4.5, reviews:7, owner:'Dev P.', art:'HEAT', image:'assets/heater.jpg', description:'Compact room heater for cold nights. Works well in small rooms. Safety instructions included.', availability:'Available tomorrow' },
  { id:9, name:'Arduino Starter Kit', category:'Electronics', price:90, originalPrice:1500, deposit:650, location:'Innovation Lab · 1.3 km', distance:1.3, rating:4.9, reviews:16, owner:'Sanya G.', art:'UNO', image:'assets/arduino.jpg', description:'Arduino board with sensors, wires, LEDs, breadboard, and basic components for mini projects.', availability:'Available this week' },
    ...
    <article class="listing-card">
      ...
      <div class="card-body">
        ...
        <div class="card-footer">
          <div><div class="price">₹${item.price}<span>/day</span></div><div class="pricing-note">6% of ₹${item.originalPrice.toLocaleString('en-IN')}</div></div>
  ...
  document.getElementById('detailContent').innerHTML = `
    <div class="detail-top">
      ...
      <div class="detail-info">
        ...
        <div class="detail-price">₹${item.price} <span>/ day · 6% of ₹${item.originalPrice.toLocaleString('en-IN')} · ₹${item.deposit} refundable deposit</span></div>
...
document.getElementById('listForm').addEventListener('submit', e => {
  ...
  const newItem = {
    ...
    price: Math.max(1, Math.round(Number(data.get('purchasePrice')) * 0.06)),
